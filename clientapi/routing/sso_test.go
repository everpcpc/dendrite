...
func (userAPI *fakeUserAPIForSSO) QueryNumericLocalpart(ctx context.Context, req *uapi.QueryNumericLocalpartRequest, res *uapi.QueryNumericLocalpartResponse) error {
	res.ID = 12345
